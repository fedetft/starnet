...
public:
    ...
    static const int wMin= 1500000; //1.5ms
    static const int wMax=10000000; //10ms
...
private:
    ...
    static const int controllerScaleFactor=1000;
    static const int varianceScaleFactor=1000;
};
